    ...
    if task:
        ...
        if env_base_url:
            return (
                ...
                resolved_model,
                env_base_url,
                env_api_key or cfg_api_key,
                env_api_mode or resolved_api_mode,
            )
        ...
        return "auto", env_model or resolved_model, None, None, env_api_mode or resolved_api_mode
